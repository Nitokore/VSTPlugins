...
tresult PLUGIN_API PlugProcessor::initialize(FUnknown *context)
{
  ...
  addAudioOutput(STR16("ExcitorOutput"), Vst::SpeakerArr::kMono);
  addAudioOutput(STR16("CymbalOutput"), Vst::SpeakerArr::kMono);
...
tresult PLUGIN_API PlugProcessor::process(Vst::ProcessData &data)
{
  ...
  if (data.numInputs != 3) return kResultOk;
  if (data.numOutputs != 3) return kResultOk;
