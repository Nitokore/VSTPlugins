...
tresult PLUGIN_API PlugProcessor::process(Vst::ProcessData &data)
{
  ...
  Logger::write("PlugProcessor::process(): data.processContext is valid");
  ...
  if (dsp->param.value[ParameterID::bypass]->getInt()) {
    ...
    Logger::write("PlugProcessor::process(): Branching to DSP processing");
...
{
  Logger::write("PlugProcessor::processBypass() is called");
  ...
  Logger::write("PlugProcessor::processBypass(): Exiting");
}
